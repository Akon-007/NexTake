...
import { Mail, Shield, ArrowUpRight, MessageSquare, CheckCircle2, Bell, Sparkles, Send, Youtube, Twitter, Video } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 pb-12 border-b border-[#161f2c]">
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="w-full max-w-sm sm:max-w-md rounded-2xl bg-white p-4 sm:p-5 shadow-xl border border-slate-200/20 group hover:shadow-2xl transition-shadow">
              <img
                src="/footer.png"
            ...
            <div className="font-mono text-[12px] leading-relaxed text-emerald-400 space-y-0.5 font-bold">
          ...
          {/* Corporate & Contact */}
          <div>
            <h4 className="text-white font-mono text-[11px] tracking-wider font-bold mb-3.5 uppercase">
              Corporate & Contact
            </h4>
            <ul className="space-y-2.5 text-[12px]">
              <li>
              ...
              <li>
                <a
                  href="mailto:nextakeafrica@gmail.com"
                  className="hover:text-emerald-400 text-slate-300 transition-colors flex items-center space-x-1.5"
                >
                  <Mail className="w-3 h-3 text-emerald-400 shrink-0" />
                  <span className="truncate">nextakeafrica@gmail.com</span>
                </a>
              </li>
              <li className="pt-1">
                <a
                  ...
                  className="text-slate-300 hover:text-cyan-400 transition-colors flex items-center space-x-1.5 group"
                >
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-300 hover:text-sky-400 transition-colors flex items-center space-x-1.5 group"
                >
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-300 hover:text-red-400 transition-colors flex items-center space-x-1.5 group"
                >
